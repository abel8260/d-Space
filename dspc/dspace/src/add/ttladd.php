...
<html>
  ...
  <body>
    ...
    <div class="cen_box_title" >
      <p class="text_cen_box"> <b>Menu de titulos:</b>
...
<?php 
 require '../../db/conexao.php';
  $sthh=$pdo->prepare("SELECT * FROM pear ");
    ...
    echo "<form  action='ttladd_bck.php' method='POST'>";
      echo $row['title_pe'];
      
  
    echo "<br/>";
echo "<input  type='hidden' class='text_cen_box cen_box' name='linkscn' value='".$row['title_pe']."' >  </input>";
